...
const title = 'Readio — Where You Read, Digest and Get Insight';
const description =
  'Discover Readio, an online ebook reader based on Readest for immersive and organized reading. ' +
  ...
  return (
    ...
    >
      <head>
        ...
        <meta name='apple-mobile-web-app-title' content='Readio' />

...
Provide a local-only quality baseline workflow that summarizes sanitized Reader AI live fixture eval metadata into deterministic JSON/Markdown snapshots without calling providers, reading raw book content, automating NotebookLM, or changing normal Reader AI UI/runtime behavior.
